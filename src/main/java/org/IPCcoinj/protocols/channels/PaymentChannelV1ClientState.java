...
package org.IPCcoinj.protocols.channels;

import com.google.common.collect.Multimap;
import com.google.common.collect.MultimapBuilder;
import org.IPCcoinj.core.*;
import org.IPCcoinj.crypto.TransactionSignature;
import org.IPCcoinj.protocols.channels.IPaymentChannelClient.ClientChannelProperties;
import org.IPCcoinj.script.Script;
import org.IPCcoinj.script.ScriptBuilder;
import org.IPCcoinj.script.ScriptException;
import org.IPCcoinj.wallet.AllowUnconfirmedCoinSelector;
import org.IPCcoinj.wallet.SendRequest;
...
public class PaymentChannelV1ClientState extends PaymentChannelClientState {
    ...
    public synchronized void initiate(@Nullable KeyParameter userKey, ClientChannelProperties clientChannelProperties) throws ValueOutOfRangeException, InsufficientMoneyException {
        ...
        // be worth revisiting.
        TransactionOutput multisigOutput = template.addOutput(totalValue, ScriptBuilder.createMultiSigOutputScript(2, keys),type);
