...
import org.IPCcoin.NativeSecp256k1;
import org.IPCcoin.NativeSecp256k1Util;
import org.IPCcoin.Secp256k1Context;
import org.IPCcoinj.wallet.Protos;
...
public class ECKey implements EncryptableItem {
     ...
     * @throws org.IPCcoinj.core.ECKey.MissingPrivateKeyException if the private key is missing or encrypted.
     */
    public byte[] toASN1() {
        try {
     ...
     * @throws org.IPCcoinj.core.ECKey.MissingPrivateKeyException if the private key bytes are missing/encrypted.
     */
