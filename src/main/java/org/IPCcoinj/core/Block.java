...
import static org.IPCcoinj.core.Coin.*;
import static org.IPCcoinj.core.Sha256Hash.*;
 ...
 * <a href="http://www.bitcoin.org.IPCcoin.pdf">the Bitcoin technical paper</a> for
...
public class Block extends Message {
    ...
    void addCoinbaseTransaction(byte[] pubKeyTo, Coin value, final int height) {
        ...
        coinbase.addOutput(new TransactionOutput(params, coinbase, value,
                ScriptBuilder.createOutputScript(ECKey.fromPublicOnly(pubKeyTo)).getProgram(), type));
    ...
    Block createNextBlock(@Nullable final Address to, final long version,
        ...
        if (to != null) {
            ...
            t.addOutput(new TransactionOutput(params, t, FIFTY_COINS, to,type));
