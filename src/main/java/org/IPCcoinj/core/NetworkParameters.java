...
package org.IPCcoinj.core;

import com.google.common.base.Objects;
import org.IPCcoinj.net.discovery.HttpDiscovery;
import org.IPCcoinj.params.MainNetParams;
import org.IPCcoinj.params.RegTestParams;
import org.IPCcoinj.params.TestNet3Params;
import org.IPCcoinj.params.UnitTestParams;
import org.IPCcoinj.script.Script;
import org.IPCcoinj.script.ScriptOpCodes;
import org.IPCcoinj.store.BlockStore;
import org.IPCcoinj.store.BlockStoreException;
import org.IPCcoinj.utils.MonetaryFormat;
import org.IPCcoinj.utils.VersionTally;
...
import static org.IPCcoinj.core.Coin.COIN;
import static org.IPCcoinj.core.Coin.FIFTY_COINS;
...
public abstract class NetworkParameters {
    ...
    public static final String ID_MAINNET = "org.ipcoin.production";
    /** The string returned by getId() for the testnet. */
    public static final String ID_TESTNET = "org.ipcoin.test";
    /** The string returned by getId() for regtest mode. */
    public static final String ID_REGTEST = "org.ipcoin.regtest";
    /** Unit test network. */
    public static final String ID_UNITTESTNET = "org.ipcoin.unittest";
    ...
    private static Block createGenesis(NetworkParameters n) {
        ...
        try {
            ...
            t.addOutput(new TransactionOutput(n, t, FIFTY_COINS, scriptPubKeyBytes.toByteArray(), type));
        } catch (Exception e) {
            // Cannot happen.
    ...
    /**
     * Scheme part for URIs, for example "zencoin".
     */
