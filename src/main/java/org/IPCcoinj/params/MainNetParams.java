...
public class MainNetParams extends AbstractBitcoinNetParams {
    ...
    public MainNetParams() {
        ...
        addressHeader = new int[] {0x04,0x1b,0x54};
        p2shHeader = new int []{0x04,0x1b,0x54};
//        acceptableAddressCodes = new int[] { addressHeader, p2shHeader };
        port = 15166;
//        packetMagic = 0xf9beb4d9L;
        packetMagic =0xdad8d7dcL;
        ...
        genesisBlock.setTime(1507824000L);
        genesisBlock.setNonce(1861207187);
        id = ID_MAINNET;
        ...
        checkpoints.put(0, Sha256Hash.wrap("00000000092a99c04ceefc5e74dabd905ab1f65166f44bc5f603aa8d1a87ad63"));
        ...
        dnsSeeds = new String[] {
                ...
                "vps.ipchainglobal.com",
                "seed.ipchainglobal.com",
                "vps.qingdoutech.com",
