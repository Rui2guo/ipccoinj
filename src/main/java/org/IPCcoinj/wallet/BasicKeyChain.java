...
import org.IPCcoinj.utils.ListenerRegistration;
import org.IPCcoinj.utils.Threading;
...
public class BasicKeyChain implements EncryptableKeyChain {
     ...
     * @throws org.IPCcoinj.wallet.UnreadableWalletException.BadPassword if the password doesn't seem to match
     * @throws org.IPCcoinj.wallet.UnreadableWalletException if the data structures are corrupted/inconsistent
     */
