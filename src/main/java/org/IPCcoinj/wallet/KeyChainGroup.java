...
import org.IPCcoinj.script.Script.ScriptType;
...
public class KeyChainGroup implements KeyBag {
     ...
     * @see org.IPCcoinj.wallet.MarriedKeyChain
     */
     ...
     *
     * @throws org.IPCcoinj.crypto.KeyCrypterException Thrown if the wallet encryption fails for some reason,
     ...
     *
     * @throws org.IPCcoinj.crypto.KeyCrypterException Thrown if the wallet decryption fails for some reason, leaving the group unchanged.
     */
